...
<body>
    <section class="section-main">
        <div class="container-fluid overflow-hidden">
                ...
                <div class="d-lg-none">
                    ...
                    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="filterDropdown" style="background-color: #f4f2f0">
                        <div class="card" style="background-color: #f4f2f0">
                            <div class="card-body">
                                <h5 class="card-title mb-3">Showing Item</h5>
                                <hr style="border-top: 2px solid black; margin-bottom: 20px;">
                                <h6 class="card-subtitle mb-3 text-body-secondary"><b>Colors</b></h6>
                                ...
                                <hr style="border-top: 2px solid black; margin-bottom: 20px;">
                                <h6 class="card-subtitle mb-3 text-body-secondary"><b>Price Range</b></h6>
                                <div class="row align-items-center mb-4">
                                    <div class="col input-group">
                                        <span class="input-group-text text-center" style="width: 100%; background-color: #f4f2f0; border-radius: 20px; border: 2px solid black">Rp. 0</span>
                                    </div>
                                    <div class="col">
                                        <p style="border-top: 2px solid black; margin-bottom: 0; width: 100%"></p>
                                    </div>
                                    <div class="col input-group">
                                        <span class="input-group-text" style="width: 100%; background-color: #f4f2f0; border-radius: 20px; border: 2px solid black">Rp. 100.000</span>
                                    </div>
                                </div>
                                <div class="mb-4">
            ...
            <div class="col-lg-12">
                <div class="row">
                    <div class="col-lg-9 d-flex justify-content-between items-list">

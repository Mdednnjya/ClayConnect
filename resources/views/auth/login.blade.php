    ...
    <body>
        <div class="container-fluid">
                ...
                <div class="col-md-4 px-sm-5 my-sm-5 my-lg-5 mx-lg-5">
                    ...
                    <div class="form px-4 pb-3">
                        <form>
                            ...
                            <div class="mb-3">
                                <!-- form untuk pw -->
                                <label for="exampleInputPassword1" class="form-label" style="font-size: 18px; font-family: 'Crimson Text'">Password</label>
            ...
            <div class="col py-sm-5 mx-sm-4 my-lg-5 mx-lg-5 mb-3">
                <div class="d-flex justify-content-center">
                <img src="{{ URL('images/login/login-asset1.svg') }}" alt="Image" width="76%" height="auto" />
                </div>
            </div>
            </div>
        </div>

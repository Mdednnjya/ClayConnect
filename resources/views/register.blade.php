...
@section('content')
    ...
    <body>
        <div class="container mt-4 mb-xl-5 mb-lg-5">
        <section class="section register d-flex flex-column align-items-center justify-content-center py-4">
            <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-4 col-lg-4 col-md-5 col-11 d-flex flex-column align-items-center justify-content-center">
                <!-- End Logo -->

                <div class="card mb-3 bg px-5 shadow rounded-2 border-0">
                    <div class="card-body">
                    <div class="pt-5 pb-5">
                    ...
                    <form class="row g-xl-3 g-lg-3 g-md-3 g-2 needs-validation" novalidate>
                        ...
                        <div class="col-12 mt-5">
                            <p class="small mb-0 text-center pt-xl-2 pt-lg-2">
                                <a href="login" class="text-decoration-none px-5 py-1 bg-black" style="font-family: 'Scheherazade New'; color: white; border-radius: 22px; font-size: 16px;"><b>Create an account</b></a>
                            </p>
                        </div>
